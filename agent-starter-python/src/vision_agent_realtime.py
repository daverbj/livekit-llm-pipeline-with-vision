        ...
        super().__init__(
            instructions=f"""
                              ...
                              Your workflow is:
                                ...
                                2. Get documentation by calling the get_documentation function.
                              ...
                              IMPORTANT: 
                                ...
                                2. Always call the get_documentation function to get relevant documentation and context based on user's query.
                                3. Stick to the provided documentation and do not make up steps.

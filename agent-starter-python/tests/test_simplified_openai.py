...
async def test_simplified_openai_processor():
    """Test the simplified OpenAI processor without detailed function instructions"""
    ...
    print("Testing simplified OpenAI processor...")
    print("Chat context:")
...
async def test_weather_function():
    """Test weather function with simplified processor"""
    ...
    print("\n" + "="*70)
    print("Testing weather function with simplified processor...")
    print("Chat context:")
    for i, msg in enumerate(chat_ctx.items):
        print(f"  {i+1}. {msg.role}: {msg.content}")
    print()
...
if __name__ == "__main__":
    asyncio.run(test_simplified_openai_processor())
